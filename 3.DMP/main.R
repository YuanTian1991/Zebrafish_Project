#############################################################
# Aurthor    : Tian
# Description: A Script for calculation of Differential Methylation Probes and Differential Methylation Regions
#############################################################

library("methylKit")

message("Removed all CpGs have 1 or 0 value across all Sampels")
load("../2.Methylkit/Data/meth.rda")
load("../2.Methylkit/Data/beta.rda")
